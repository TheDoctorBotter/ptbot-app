...
INSERT INTO protocol_phases (protocol_id, phase_number, name, display_order, goals, precautions, progress_criteria)
...
ON CONFLICT (protocol_id, phase_number) DO UPDATE SET name = EXCLUDED.name, goals = EXCLUDED.goals, precautions = EXCLUDED.precautions, progress_criteria = EXCLUDED.progress_criteria;
