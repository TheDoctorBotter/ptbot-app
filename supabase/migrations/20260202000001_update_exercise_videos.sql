-- Migration: Update exercise videos with correct YouTube links and add new exercises
-- Date: 2026-02-02

-- ============================================
-- PART 1: UPDATE EXISTING EXERCISES
-- ============================================
...
INSERT INTO exercise_videos (
  ...
  25, true
) ON CONFLICT (title) DO UPDATE SET youtube_video_id = 'O_GEUdxQETA';
...
INSERT INTO exercise_videos (
  ...
  15, true
) ON CONFLICT (title) DO UPDATE SET youtube_video_id = 'qYvYsFrTI0U';
...
INSERT INTO exercise_videos (
  ...
  16, true
) ON CONFLICT (title) DO UPDATE SET youtube_video_id = 'IAMfLvZqAhs';
...
INSERT INTO exercise_videos (
  ...
  30, true
) ON CONFLICT (title) DO UPDATE SET youtube_video_id = 'plOcKUYoBWQ';
...
INSERT INTO exercise_videos (
  ...
  40, true
) ON CONFLICT (title) DO UPDATE SET youtube_video_id = '2Zy07ygEAko';
...
INSERT INTO exercise_videos (
  ...
  42, true
) ON CONFLICT (title) DO UPDATE SET youtube_video_id = 'iCZbtG0WosA';
...
INSERT INTO exercise_videos (
  ...
  43, true
) ON CONFLICT (title) DO UPDATE SET youtube_video_id = 'WoP0-kLXsRo';
...
INSERT INTO exercise_videos (
  ...
  44, true
) ON CONFLICT (title) DO UPDATE SET youtube_video_id = 'LIi-akh1zZc';
...
INSERT INTO exercise_videos (
  ...
  45, true
) ON CONFLICT (title) DO UPDATE SET youtube_video_id = 'fLa7o3w6W2o';
...
INSERT INTO exercise_videos (
  ...
  46, true
) ON CONFLICT (title) DO UPDATE SET youtube_video_id = 'xdo0gi77SL0';
...
INSERT INTO exercise_videos (
  ...
  50, true
) ON CONFLICT (title) DO UPDATE SET youtube_video_id = '7rnlAVhAK-8';
...
INSERT INTO exercise_videos (
  ...
  51, true
) ON CONFLICT (title) DO UPDATE SET youtube_video_id = 'GSoXPJRnR6E';
